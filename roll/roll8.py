...
print(f'stash {my_account.getStash()}, current balance {my_account.getCurrentBalance()}, green hits {my_account.getRouletteHits().count(3)}')
print(f'max non green streak {max(my_account.getNoGreenStreaks())}')
print(f'average non green streak {round(sum(my_account.getNoGreenStreaks())/len(my_account.getNoGreenStreaks()), 2)}')
